# Generated by Django 4.2.5 on 2023-11-10 11:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.CharField(choices=[('3 jours', '3 jours'), ('Hebdomadaire', 'Hebdomadaire'), ('Mensuel', 'Mensuel'), ('Trimestriel', 'Trimestriel')], default='3 jours', max_length=20, unique=True)),
                ('priceTeacher', models.IntegerField(default=1000)),
                ('priceStudent', models.IntegerField(default=1000)),
                ('daysNumber', models.IntegerField(choices=[(1, 3), (2, 5), (3, 30), (4, 90)])),
            ],
        ),
        migrations.CreateModel(
            name='CustomUser',
